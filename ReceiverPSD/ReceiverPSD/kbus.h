...
#define KBUS_PORT				PORTE
#define KBUS_RX_PIN_bm			PIN2_bm
#define KBUS_TX_PIN_bm			PIN3_bm
#define KBUS_RX_PINCTRL			PIN2CTRL

#define KBUS_USART				USARTE0
#define KBUS_USART_RXC_vect		USARTE0_RXC_vect

#define KBUS_TC					TCE0
#define KBUS_TC_OVF_vect		TCE0_OVF_vect
#define KBUS_TC_CCA_vect		TCE0_CCA_vect

#define KBUS_DMA_CH				DMA.CH0
#define KBUS_DMA_TRIGGER_SRC	DMA_CH_TRIGSRC_USARTE0_RXC_gc

#define KBUS_EVENT_CTRL			EVSYS.CH0CTRL
#define KBUS_EVENT_MUX			EVSYS_CHMUX_PORTE_PIN2_gc
#define KBUS_EVSEL				TC_EVSEL_CH0_gc
