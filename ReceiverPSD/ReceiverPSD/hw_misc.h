...
#define DC_SENSE_PIN_bm			PIN1_bm
#define DC_DA_PIN_bm			PIN2_bm
#define DC_DB_PIN_bm			PIN3_bm

#define PSX_PORT				PORTC
#define PSX_ATT_INT_PIN_bm		PIN2_bm
...
#define LED_GREEN_PIN_bm		PIN1_bm
#define LED_BLUE_PIN_bm			PIN3_bm

#define USB_PORT				PORTD
#define USB_VBUS_PIN_bm			PIN5_bm
